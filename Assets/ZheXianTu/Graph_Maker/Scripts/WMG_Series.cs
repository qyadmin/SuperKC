...
public class WMG_Series : MonoBehaviour {
	...
	[SerializeField] public List<Vector2> _pointValues;
	...
	public void AddLabeValue(List<string> collection)
	{
	...
	private List<string> LableName = new List<string>();
	...
	public string getNodeName(WMG_Node aNode) {
		for (int i = 0; i < pointValues.Count; i++) {
