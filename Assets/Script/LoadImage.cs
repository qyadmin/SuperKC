...
public class LoadImage : MonoBehaviour
{
    ...
    IEnumerator UploadTexture(string GetTex, int typeimg)
    {
        ...
        else
        {
            ...
            if (typeimg == 0)
            {
                //http_becomeBoss.Data.AddData(GlobalData.zhizhao, jd["zhizhao"].ToString());

            }
            else
            {
                //http_becomeBoss.Data.AddData(GlobalData.shopimg, jd["zhizhao"].ToString());
