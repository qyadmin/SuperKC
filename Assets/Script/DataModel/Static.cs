...
public class Static
{
    ...
    public GameSetting LaodConfig { get { return SetData; } }

    public string URL = "http://39.106.225.213:80/";//http://gate.23032.top/
    public string LocalURL = "http://39.106.225.213:80/";
    public string SaveName = "CJKC";
    ...
    public bool GetEmptyBool(string Name)
    {
        string ValueGet = null;
        SaveMessage.TryGetValue(Name, out ValueGet);
        if (ValueGet == string.Empty)
            return true;
        return false;
    }
